...
For Deep learning projects, we have:
  ...
  - **Text Generation (ChatBot)**: Generate model able to answer questions about a document. Then buils an interface for a better communication --description to change
